...
total_sales = 0
sales = [value.replace('$','') for value in sales]
sales = [float(value) for value in sales]
total_sales = sum(sales)
print(total_sales)
print(thread_sold)
thread_sold_split = [color.split("&") for color in thread_sold]
thread_sold_split = [color for item in thread_sold_split for color in item]
print(thread_sold_split)

def color_count(color, lst):
  count = 0
  for i in lst:
    if i == color:
      count += 1
  return count
print(color_count("white", thread_sold_split))

colors = ['red','yellow','green','white','black','blue','purple']

for color in colors:
  print (color + " = " + str(color_count(color, thread_sold_split)))
